...
class TeasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tea" do
    assert_difference('Tea.count') do
      post teas_url, params: { tea: { brand: @tea.brand, country: @tea.country, quantity: @tea.quantity, style: @tea.style } }, as: :json
    end
  ...
  test "should update tea" do
    patch tea_url(@tea), params: { tea: { brand: @tea.brand, country: @tea.country, quantity: @tea.quantity, style: @tea.style } }, as: :json
    assert_response 200
  end
